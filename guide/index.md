...
如果从 github clone 代码较慢的话，可以尝试用 [Gitee](https://gitee.com/Ahjung/naive-ui-admin) 同步代码到自己的仓库，再 clone 下来即可。

也可以通过下方地址进行 clone

```bash
git clone https://gitee.com/Ahjung/naive-ui-admin.git
```

::: warning 注意

[Gitee](https://gitee.com/Ahjung/naive-ui-admin.git)的代码可能不是最新的
